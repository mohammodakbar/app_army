...
<?php 
	...
	$db 	= new database;
	$rel_id = $_GET['profile'];
	$sel	= $db->query("SELECT * FROM basic_info  WHERE army='$rel_id'");
...
<script>
    ...
    $(document).ready(function (e){
        ...
        e.preventDefault();
        $.ajax({
            url: "<?php echo PROOT;?>public/ajax/step-2.php?rel_id=<?= $rel_id; ?>",
            type: "POST",
            dataType: 'JSON',
			  ...
			  complete: function(){
				...
				success : function(data){
					...
					if (data.code == "200"){
						...
						setTimeout(' window.location.href = "<?= PROOT;?>soldier"; ',1000);
...
<div class="col-md-12">
	<div class="bread">
		...
		<span style="font-size:13px;font-weight:300"> | Edit soldier information </span>
            <a href="<?= PROOT;?>soldier/admission/step-1/" class="btn btn-info btn-sm pull-right">New Form</a>
    </div>
	<br />
	<br />
	<br />
				...
				<div class="panel-body">
					...
					<form action="<?php $_SERVER['PHP_SELF'];?>" method="post" id="form_step_2">
						...
						<div class="col-md-6 ln">
							...
							<h5 class="sub_head">Previous Unit</h5>
							<div class="input_fields_wrap" >
								<div class="row" >
									<div class="field">
										<div class="col-md-3">
											<div class="form-group">
												<label for="class_name">Unit</label>
								...
								<?php 
									$qri = $db->query("SELECT * FROM previous_unit WHERE rel_id='$rel_id'");
									while($res = $db->fetch($qri)){
								?>
								<div class="row" >
									<div class="field">
										<div class="col-md-3">
											<div class="form-group">
												<label for="class_name">Unit</label>
												<input type="text"  class="form-control" name="unit[]" value="<?= $res['p_unit'];?>"/>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
							...
							<h5 class="sub_head">GSBP (Good Service Basic Pay)</h5>
							<div class="input_fields_wrap2" >
								<div class="row" >
									<div class="field">
										<div class="col-md-3">
											<div class="form-group">
												<label for="class_name">Step</label>
												<input type="text"  class="form-control" name="step[]" id="className"/>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label for="class_name">Date</label>
												<input placeholder="MM/YYYY" type="text"  class="form-control" name="date[]" id="className"/>
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group">
												<label for="class_name">Rmks</label>
												<input type="text"  class="form-control" name="rmks[]" id="className"/>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
												<a href="" class="add_field_button2 btn btn-info" id="addScnt" style="margin-top:20px ">
                                                    <i class="fa fa-plus"></i></a>
											</div>
										</div>
									</div>
							...
							<h5 class="sub_head">Punishment Description</h5>
							<div class="input_fields_wrap3" >
								<div class="row" >
									<div class="field">
										<div class="col-md-6">
											<div class="form-group">
												<label for="class_name">Desciption</label>
												<input type="text"  class="form-control" name="description[]" id="className"/>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label for="class_name">Type</label>
												<input type="text"  class="form-control" name="type[]" id="className"/>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
							...
							<h5 class="sub_head">Army Training</h5>
									...
									<div class="field">
										<div class="col-md-3">
											<div class="form-group">
												...
												<input type="text"  class="form-control" name="course[]" id="className"/>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
										...
										<div class="col-md-2">
											<div class="form-group">
												<label for="class_name">Result</label>
												<input type="text"  class="form-control" name="result[]" id="className"/>
											</div>
										</div>
                                        <div class="col-md-3">
											<div class="form-group">
												<label for="class_name">Name of Ins</label>
												<input type="text"  class="form-control" name="name_of_ins[]" id="className"/>
											</div>
										</div>
										
										<div class="col-md-2">
											<div class="form-group">
												<a href="" class="add_field_button5 btn btn-info" id="addScnt" style="margin-top:20px "><i class="fa fa-plus"></i></a>
											</div>
										</div>
									</div>
								</div>
                            ...
                            <h5 class="sub_head">UN-Mission</h5>
									...
									<div class="field">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text"  class="form-control" name="nok_name[]" id="className"/>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
												<label for="class_name">Relations</label>
												<input type="text"  class="form-control" name="nok_relation[]" id="className"/>
											</div>
										</div>
                                        <div class="col-md-2">
											<div class="form-group">
												<label for="class_name">%</label>
												<input type="text"  class="form-control" name="nok_parcent[]" id="className"/>
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
												<a href="" class="add_field_button8 btn btn-info" id="addScnt" style="margin-top:20px "><i class="fa fa-plus"></i></a>
											</div>
										</div>
									</div>
								</div>
